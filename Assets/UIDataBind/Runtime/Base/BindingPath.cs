...
namespace UIDataBind.Base
{
    ...
    public struct BindingPath : IComparable, IComparable<BindingPath>, IEquatable<BindingPath>
    {
        public const int MaxLength = 11;
        public static readonly BindingPath Empty;
        ...
        public static BindingPath GetParent(BindingPath path)
        {
            if (path._length == 0)
                return Empty;
